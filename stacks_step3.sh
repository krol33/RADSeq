...
python /save/mbernard/script/git/galaxy_wrappers/stacks_summary.py --stacks-prog sstacks --res-dir $SSTACKS_DIR --pop-map $POP_FILE --summary $STAT_DIR/sstacks_summary.html
