...
#$ -o [Project_path_dir]/SGE_out/stacks.out
#$ -e [Project_path_dir]/SGE_out/stacks.err
#$ -N [Proj_Name]_stacks
#$ -S /bin/sh
#$ -q unlimitq
...
OUT_DIR=$RAD_DIR/denovo_map
SGE=$RAD_DIR/SGE_out/denovo_map
STAT_DIR=$RAD_DIR/stat/denovo_map
...
# -t = -d -r dans ustacks
echo perl $stacks_dir/denovo_map.pl $sample -o $OUT_DIR -t -m 3 -M 2 -N 4 -n 1 -T 10 -O $POP_FILE -b 1 -i 1 -e $stacks_dir -S -X \"ustacks:--max_locus_stacks 3\"  > $SGE/denovo_map.sh
